...
INSERT INTO customer 
  (customer_ID,customer_type_ID,customer_name,customer_birthday,gender,customer_code,phone_number,email,address) 
VALUES 
...
INSERT INTO service 
  (service_ID,service_name,service_area,rent_fee,maximum_person,rent_type_ID,service_type_ID,room_standard,other_description,pool_area,floor_amount) 
VALUES 
...
INSERT INTO addtional_service 
  (additional_service_ID,additional_service_name,additional_service_price,unit,status) 
VALUES 
...
INSERT INTO constract_detail 
  (constract_detail_ID,constract_ID,additional_service_ID,quantity) 
VALUES 
  (1,2,4,5),
  (2,2,5,8),
  (3,2,6,15),
